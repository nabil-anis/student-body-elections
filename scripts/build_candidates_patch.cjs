...
const candidates = {
  ...
  // FINAL REVISIONS AS REQUESTED BY USER
  abdul: {
  ...
  waqar: {
    ...
    traits: [
      { icon: "Check", title: "Unhinged Execution", desc: "Will happily cancel an entire event if the promotional banner is 1cm off-center." },
      { icon: "Users", title: "Aggressively Proactive", desc: "Fired the DJ before the event even started just to send a message." },
