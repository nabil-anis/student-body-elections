...
const candidates = {
  ...
  // Keep these five EXACTLY as they were based on user request (no spreadsheet/excel removed, though Maryam had one, wait! User said "dont mention spreadsheets or excel". Maryam had "spreadsheets" in her easter egg. I will change her easter egg to "Notion dashboard").
  minhaj: {
  ...
  abdul: {
    ...
    traits: [
      { icon: "Globe", title: "Aura +10000", desc: "Entered the election as a side quest, immediately became the main character." },
      { icon: "Users", title: "Algorithm Manipulator", desc: "His TikTok drafts are classified by the CIA. Pure brainrot genius." },
  ...
  mohsin: {
    name: "Mohsin Ahmed", positionName: "President", badgeText: "Vibe Checker", imageSrc: "./assets/mohsin.jpeg",
    quote: "Bro, trust me, the venue is sorted. (It is definitely not sorted).",
    traits: [
      { icon: "Globe", title: "Clutch God", desc: "Can organize a Qawwali night during a monsoon flood on Tariq Road." },
      { icon: "Users", title: "Vibe Checker", desc: "Will personally escort you out if your fit doesn't pass the vibe check." },
      { icon: "Trophy", title: "The Connect", desc: "Fyre Festival organizers beg him for logistics advice.", onClick: true }
    ],
    easterEgg: { quote: "I used to think my festival was a logistical nightmare until I saw Mohsin plan a 500-person rave on a Karachi rooftop with zero budget. He is Him.", author: "Fyre Festival Organizer", year: "2017" }
  },
  waqar: {
    ...
    traits: [
      ...
      { icon: "Trophy", title: "The Final Boss", desc: "Shoaib Akhtar thinks his death stare is too aggressive.", onClick: true }
    ],
    easterEgg: { quote: "I bowled at 161 km/h, but Waqar's death stare when the biryani runs out at an event is way faster.", author: "Shoaib Akhtar", year: "2003" }
  },
  sabeen: {
    ...
    traits: [
      { icon: "Globe", title: "Time Weaver", desc: "Knows exactly how to beat Shahrah-e-Faisal traffic at 6 PM. A true miracle." },
  ...
  shafaq: {
    ...
    traits: [
      ...
      { icon: "Globe", title: "Street Smarts", desc: "Knows the exact shortcut through Gulshan to avoid the traffic cops." },
  ...
  anish: {
    ...
    traits: [
      ...
      { icon: "Mic", title: "Yapper", desc: "Will talk about Web3 until you agree to vote for him just to make it stop." },
      { icon: "Users", title: "The Visionary", desc: "Sam Altman asked him for ChatGPT prompts.", onClick: true }
    ],
    easterEgg: { quote: "We trained GPT-4 on billions of parameters, but Anish's ability to yap for 45 minutes without making a single point? Unreplicable.", author: "Sam Altman", year: "2024" }
  },
  bakhtawar: {
  ...
  zaki: {
    ...
    traits: [
      { icon: "Trophy", title: "Jugaad Pro Max", desc: "Can fix the campus Wi-Fi using just a paperclip and good intentions." },
      { icon: "Globe", title: "The Plug", desc: "Needs notes? Needs past papers? Needs a VIP pass? Zaki has it." },
      { icon: "Check", title: "The Operator", desc: "Batman wishes he had his utility belt.", onClick: true }
    ],
    easterEgg: { quote: "I used to think my gadgets were cool, until I saw Zaki fix a blown speaker 5 minutes before the event with sheer jugaad.", author: "Batman", year: "Gotham" }
  },
  ashba: {
    ...
    traits: [
      ...
      { icon: "Users", title: "Bargain Hunter", desc: "Will argue in Zainab Market until the shopkeeper pays HER to take the shirt." },
